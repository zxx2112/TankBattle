...
namespace UnityEditor.VisualScriptingTests
{
    ...
    class ConnectedToStackConstraint : Constraint
    {
        ...
        public override ConstraintResult ApplyTo(object actual)
        {
            ...
            isConnected |= graphModel.EdgeModels.Any(x => Equals((StackBaseModel)x.InputPortModel.NodeModel, actualStack) && Equals((StackBaseModel)x.OutputPortModel.NodeModel, m_ExpectedStack));
            isConnected |= graphModel.EdgeModels.Any(x => Equals((StackBaseModel)x.InputPortModel.NodeModel, m_ExpectedStack) && Equals((StackBaseModel)x.OutputPortModel.NodeModel, actualStack));
