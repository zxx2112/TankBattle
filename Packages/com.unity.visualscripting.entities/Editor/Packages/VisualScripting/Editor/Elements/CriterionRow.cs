...
namespace Packages.VisualScripting.Editor.Elements
{
    class CriterionRow : SortableExpandableRow, IVisualScriptingField, ICustomSearcherHandler
    {
        ...
        static SerializedPropertyType[] s_PropsToHideLabel =
        {
        ...
        bool EditorNeedsLabel
        {
            get
            {
                SerializedProperty prop = m_WatchedObject?.FindProperty("m_NodeModel.value");
                return prop != null && s_PropsToHideLabel.Contains(prop.propertyType);
            }
        }

        SerializedObject m_WatchedObject;
