...
namespace UnityEditor.VisualScripting.Model.Translators
{
    ...
    public class RoslynEcsTranslator : RoslynTranslator
    {
        ...
        public class IterationContext
        {
            ...
            public string GetComponentDataArrayName(Type resolvedType)
            {
                return $"{GroupName}{resolvedType.Name}Array";
            }
            ...
            StackExitStrategy exitStrategy = StackExitStrategy.Return)
        {
            switch (stack)
            {
                ...
                case IIteratorStackModel iteratorStackModel when iteratorStackModel.ContainsCoroutine():
                    BuildCoroutine(ref block);
                    return;
