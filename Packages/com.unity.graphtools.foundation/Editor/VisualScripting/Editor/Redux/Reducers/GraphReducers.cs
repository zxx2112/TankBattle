...
namespace UnityEditor.VisualScripting.Editor
{
    static class GraphReducers
    {
        ...
        static State RenameElement(State previousState, RenameElementAction action)
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo(action.RenamableModel.SerializableAsset, "Renaming graph element");
        ...
        static State MoveElements(State previousState, MoveElementsAction action)
        {
            ...
            {
                Undo.RegisterFullObjectHierarchyUndo((Object)previousState.AssetModel.GraphModel, "Move");
