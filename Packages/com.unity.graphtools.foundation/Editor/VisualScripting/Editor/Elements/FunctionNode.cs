    ...
    public class FunctionNode : StackNode, IRenamable
    {
            ...
            : base(store, functionModel, nodeBuilder)
        {
            ...
            else
            {
                ...
                if (functionModel.NodeAssetReference != null)
                {
                    RegisterCallback<AttachToPanelEvent>(evt => m_TitleLabel.Bind(new SerializedObject(functionModel.NodeAssetReference)));
