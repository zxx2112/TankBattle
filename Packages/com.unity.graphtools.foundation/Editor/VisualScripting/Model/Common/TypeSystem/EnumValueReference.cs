...
/*        public static implicit operator EnumValueReference(Enum t)
        {
            EnumValueReference r = new EnumValueReference { value = t };
            return r;
        }

        public static implicit operator Enum(EnumValueReference r)
        {
            return r.value;
        }*/
    }
