                        ...
                        else
                        {
                            children.Add(new GraphNodeModelSearcherItem(
                                ...
                                data =>
                                {
                                    ...
                                    Undo.RegisterCompleteObjectUndo(getPropertyGroupModel.NodeAssetReference, "Add Member");
                                    getPropertyGroupModel.AddMember(propertyInfo.GetUnderlyingType(), propertyInfo.Name);
                                    EditorUtility.SetDirty(getPropertyGroupModel.NodeAssetReference);
                ...
                if (fieldInfo.CanWrite())
                {
                    parent.AddChild(new StackNodeModelSearcherItem(
                        ...
                        data =>
                        {
                            ...
                            Undo.RegisterCompleteObjectUndo(nodeModel.NodeAssetReference, "Add Member");
                            nodeModel.AddMember(fieldInfo.GetUnderlyingType(), fieldInfo.Name);
                            EditorUtility.SetDirty(nodeModel.NodeAssetReference);
                            return nodeModel;
                        },
                        fieldInfo.Name
                    ));
