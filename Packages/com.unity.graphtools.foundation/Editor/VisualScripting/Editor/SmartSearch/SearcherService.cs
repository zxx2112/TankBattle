...
namespace UnityEditor.VisualScripting.Editor.SmartSearch
{
    public static class SearcherService
    {
        ...
        internal static void ShowOutputToStackNodes(State state, IStackModel stackModel, IPortModel portModel,
        ...
        internal static void ShowGraphNodes(State state, Vector2 position, Action<GraphNodeModelSearcherItem> callback)
        {
            var stencil = state.CurrentGraphModel.Stencil;
