...
namespace UnityEditor.VisualScripting.GraphViewModel
{
    public interface IStackModel : INodeModel
    {
        ...
        TNodeModel CreateStackedNode<TNodeModel>(string nodeName = "", int index = -1, SpawnFlags spawnFlags = SpawnFlags.Default, Action<TNodeModel> preDefineSetup = null, GUID? guid = null) where TNodeModel : NodeModel;
