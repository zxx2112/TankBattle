...
using UnityEditor.VisualScripting.Models.NodeAssets;
using UnityEngine;
    ...
    public class CriteriaTests : EndToEndCodeGenBaseFixture
    {
        ...
        public void TestSingleCriteriaModel([Values] CodeGenMode mode)
        {
            SetupTestGraph(mode, graphModel =>
            {
                ...
                var criteria = ScriptableObject.CreateInstance<CriteriaModel>();
        ...
        Criterion GetDummyFloat3Criterion(BinaryOperatorKind kind)
        {
            ...
            var asset = ScriptableObject.CreateInstance<Float3ConstantAsset>();
            var value = asset.Node;
        ...
        Criterion GetDummyFloat3ValueCriterion()
        {
            ...
            var asset = ScriptableObject.CreateInstance<IntConstantAsset>();
            var value = asset.Node;
            value.value = 20;
        ...
        Criterion GetDummyBoolCriterion()
        {
            ...
            var asset = ScriptableObject.CreateInstance<BooleanConstantNodeAsset>();
            var value = asset.Node;
            value.value = true;
