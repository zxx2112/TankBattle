...
namespace UnityEditor.VisualScripting.Editor
{
    ...
    class VseBlankPage : VisualElement
    {
        ...
        static IEnumerable<IOnboardingProvider> OnboardingProviders
        {
            get
            {
                // new() object of every class inheriting from IOnboardingProvider
                return s_OnboardingProviders ??
                    (s_OnboardingProviders = TypeCache.GetTypesDerivedFrom<IOnboardingProvider>()
